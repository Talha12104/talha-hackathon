        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="mt-4 text-gray-600 leading-relaxed text-sm sm:text-base">
                Hi, I’m <span className="font-semibold">Muhammad Talha</span>, an enthusiastic developer exploring the limitless
          ...
          <div className="bg-[#FEE5E5] sm:bg-[#EDEFFB] p-6 rounded-lg">
            ...
            <div className="mt-6 flex justify-center space-x-8 text-center text-2xl text-[#1D3178]">
              {/* Gmail */}
              <a
                href="mailto:talha12104@gmail.com"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/de00vin/"
                className="hover:text-[#FB2E86] transition duration-300"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              {/* GitHub */}
              <a
                href="https://github.com/talha12104"
                className="hover:text-[#FB2E86] transition duration-300"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/in/talha-12104/"
                className="hover:text-[#FB2E86] transition duration-300"
                target="_blank"
                rel="noopener noreferrer"
              >
