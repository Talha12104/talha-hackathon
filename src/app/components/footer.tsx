...
function Footer() {
  ...
  <div className="bg-[#E7E4F8]">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <Link 
      target='blank' href={"https://www.facebook.com/share/15sM5PHQ5M/"} className="text-gray-900">
      <FaFacebook className='text-3xl ' />
      </Link>

      <Link
      target='blank' href={"https://vercel.com/talha12104s-projects"} className="ml-3 text-gray-900">
      <IoLogoVercel className='text-3xl' />
      </Link>
      
      <Link
      target='blank' href={"https://www.linkedin.com/in/muhammad-talha12104/"} className="ml-3 text-gray-900">
